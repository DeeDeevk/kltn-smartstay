...
async function bootstrap() {
  ...
  // credentials: true để trình duyệt gửi/nhận cookie khi frontend gọi API khác
  // cổng/domain — khi đó origin bắt buộc phải liệt kê cụ thể, không dùng "*".
  app.enableCors({ origin: corsOrigins, credentials: true });
  // Socket xác thực bằng token trong handshake (không dùng cookie) nên không cần credentials.
